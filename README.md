...
### How to view this project online

This project can be seen online using the link: https://sprucepine.github.io/mla-text-editor/

Whenever a change is made to the main branch, this site will update with new changes. 
